...
impl ASTStatement {
    ...
    pub fn return_statement(return_keyword: Token, return_value: Option<ASTExpression>) -> Self {
        ASTStatement::new(
            ASTStatementKind::Return(ASTReturnStatement { return_keyword, return_value })
        )
    }
    ...
    pub fn func_decl_statement(
        ...
        ASTStatement::new(
            ASTStatementKind::FuncDecl(ASTFuncDeclStatement {
                identifier,
                parameters,
                body: Box::new(body),
            })
...
impl ASTExpression {
    ...
    pub fn assignment(identifier: Token, expression: ASTExpression) -> Self {
        ASTExpression::new(
            ASTExpressionKind::Assignment(ASTAssignmentExpression {
                identifier,
                expression: Box::new(expression),
            })
        )
